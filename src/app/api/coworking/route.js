import { coworkingBookings, db } from "@/drizzle/schema"; // Drizzle ORM schema
...
export async function POST(request) {
  try {
    ...
    await db.insert(coworkingBookings).values(body);
    ...
    const htmlTemplate = `
    <h2>New Coworking Booking Submission</h2>
  ...
  `;
    ...
    const mailOptions = {
      ...
      subject: "Co-working booking form",
